$(document).ready(function () {
  ...
  function calendario() {
    ...
    // Inicialización del calendario con v6
    calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      eventContent: function(arg) {
        // Aquí puedes personalizar cómo se muestran los eventos
        return {
          html: `<div class="fc-event-custom">
                  <div class="fc-event-title">${arg.event.title}</div>
                  <div class="fc-event-desc">${arg.event.extendedProps.descripcion || ''}</div>
                </div>`
        }
      },
      ...
      eventClick: function(info) {
        ...
        $.ajax({
          ...
          success: function (data) {
            if (data[0].tipo_p == 0) {
              // Manejo para otros tipos de eventos
            } else {
  ...
  // El resto de tu código (tablas, handlers de eventos, etc.) puede permanecer igual
  // ...