...
$consulta = "SELECT * FROM consultorio WHERE edo_con=1 ORDER BY id_con";
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header bg-green text-light">
                <h1 class="card-title mx-auto">CONSULTORIOS</h1>
            </div>
                            ...
                            <div class="table-responsive">
                                <table name="tablaV" id="tablaV" class="table table-sm table-striped table-bordered table-condensed text-nowrap w-auto mx-auto" style="width:100%; font-size:14px">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $dat['id_con'] ?></td>
                                                <td><?php echo $dat['nombre_con'] ?></td>
...
<script src="fjs/cntaconsultorio.js?v=<?php echo (rand()); ?>"></script>
